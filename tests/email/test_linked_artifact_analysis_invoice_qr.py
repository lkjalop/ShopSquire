...
from tests.security.synthetic_samples import synthetic_pdf_bytes
...
def test_linked_artifact_analysis_uses_invoice_qr_offline_fixture(
    ...
    fixture = tmp_path / "synthetic-invoice.pdf"
    fixture.write_bytes(synthetic_pdf_bytes())
    monkeypatch.setattr(
        mod,
        ...
        lambda: {
            "entries": [
                {
                    "urls": [
                        "https://ingram-verify-test.com/payment/verify?inv=INV-2026-00847"
                    ],
                    "local_path": str(fixture),
                    "content_type": "application/pdf",
                    "filename": fixture.name,
                    "tag": "invoice_qr_payment_lure_fixture",
                }
            ]
        },
    )
