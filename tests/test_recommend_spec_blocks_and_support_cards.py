from src.app.services.recommend_support_context import (
    infer_account_warranty_status,
    parse_explicit_spec_blocks,
)
...
def test_parse_explicit_spec_blocks_min_and_recommended():
    ...
    out = parse_explicit_spec_blocks(q)
...
def test_parse_explicit_spec_blocks_none():
    out = parse_explicit_spec_blocks("show me laptops for school around 1200")
...
def test_infer_account_warranty_status_empty_uid():
    out = infer_account_warranty_status("")
