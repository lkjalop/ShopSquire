...
foreach ($n in "COMMERCE_CATALOG_ENABLED","FULFILLMENT_DEMO_ENABLED","FULFILLMENT_CASES_ENABLED","FULFILLMENT_BULK_THRESHOLD","OWNER_API_KEY","VITE_API_BASE","EXTERNAL_RESEARCH_ENABLED","EXTERNAL_RESEARCH_AUTO_AUTHORIZED","EXTERNAL_RESEARCH_SEARCH_URL","VITE_EXTERNAL_RESEARCH_AUTO_ENABLED") {
