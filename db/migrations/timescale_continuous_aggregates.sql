-- TimescaleDB continuous aggregates for SLO monitoring
-- Example p95 request latency approximation via histogram buckets aggregated over 5 minutes
-- Requires metrics stored in Postgres; for Prometheus, keep this as reference.
