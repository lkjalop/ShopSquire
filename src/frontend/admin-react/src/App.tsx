  ...
  return (
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="nav">
          {['overview', 'decisions', 'security', 'cv-incidents', 'inventory-sync', 'email-incidents', 'playbooks', 'rules', 'approvals', 'orders', 'analytics', 'grafana', 'incidents', 'compliance', 'grc'].map((key) => {
