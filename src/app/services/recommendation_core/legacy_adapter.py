...
def _full_pipeline(core: CoreResponse) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        **_universal(core),
        ...
        "workload_authorization": core.extras.get("workload_authorization"),
        "ambiguity_exploration": core.extras.get("ambiguity_exploration"),
        "execution_state_envelope": core.extras.get("execution_state_envelope"),
        "control_faults": core.extras.get("control_faults", []),
        "experiential_failure_lesson": core.extras.get("experiential_failure_lesson"),
