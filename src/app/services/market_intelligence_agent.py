...
def _finding_dict(f: Any, *, tenant_id: str) -> Dict[str, Any]:
    ...
    typed = MarketEvidence(
        ...
        measurement_definition=evidence.get("measurement_definition"),
        ...
        magnitude_low=evidence.get("magnitude_low"),
        magnitude_high=evidence.get("magnitude_high"),
        propagation_lag_min_days=evidence.get("propagation_lag_min_days"),
        propagation_lag_max_days=evidence.get("propagation_lag_max_days"),
        dependency_path_ids=list(evidence.get("dependency_path_ids") or []),
        supporting_evidence_ids=list(evidence.get("supporting_evidence_ids") or []),
        contradicting_evidence_ids=list(evidence.get("contradicting_evidence_ids") or []),
        assumptions=list(evidence.get("assumptions") or []),
        alternative_explanations=list(evidence.get("alternative_explanations") or []),
